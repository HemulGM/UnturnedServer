...
interface
 uses
  ...
  System.Math, System.Rtti, System.TypInfo, Vcl.ComCtrls, Vcl.Imaging.jpeg, Main.MD5, Vcl.Grids, Vcl.Imaging.pngimage;
...
function MD5(S:string):string;
begin
 Result:=AnsiUpperCase(MD5DigestToStr(MD5String(S)));
end;
