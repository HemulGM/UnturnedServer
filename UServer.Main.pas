...
uses
  ...
  System.Win.ScktComp, System.Generics.Collections, System.Actions, System.DateUtils,
  System.ImageList, System.IniFiles, System.Win.Registry,
  //VCL
  Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Direct2D,
  Vcl.ExtCtrls, Vcl.Buttons, Vcl.ImgList, Vcl.ComCtrls, Vcl.ActnList, Vcl.Imaging.jpeg,
  Vcl.Grids, Vcl.Menus, Vcl.Imaging.pngimage, Vcl.OleCtrls,
  //Data
  ...
  //AC
  acPNG, sPanel, sPageControl, sSpeedButton,
  //
...
type
  ...
  TFormMain = class(TForm)
    ...
    ButtonGetPlayerP: TsSpeedButton;
    ButtonPermAdd: TsSpeedButton;
    ButtonPermRemove: TsSpeedButton;
    ...
    SpeedButtonAirdrop: TsSpeedButton;
    SpeedButtonChatDown: TsSpeedButton;
    SpeedButtonChatFilter: TsSpeedButton;
    SpeedButtonChatRefresh: TsSpeedButton;
    SpeedButtonChatSend: TsSpeedButton;
    SpeedButtonClearCache: TsSpeedButton;
    SpeedButtonClearCookies: TsSpeedButton;
    SpeedButtonCommandExe: TsSpeedButton;
    SpeedButtonConProc: TsSpeedButton;
    SpeedButtonCreateDonat: TsSpeedButton;
    SpeedButtonCurSteamInfo: TsSpeedButton;
    SpeedButtonDayTime: TsSpeedButton;
    SpeedButtonDBPIGeo: TsSpeedButton;
    SpeedButtonDBPIGeoStop: TsSpeedButton;
    SpeedButtonDBPIRefresh: TsSpeedButton;
    SpeedButtonDonat: TsSpeedButton;
    SpeedButtonDonatDeactivate: TsSpeedButton;
    SpeedButtonDonatDelete: TsSpeedButton;
    SpeedButtonDonatExtend: TsSpeedButton;
    SpeedButtonDonatUnlimit: TsSpeedButton;
    SpeedButtonEventsDown: TsSpeedButton;
    SpeedButtonExeBan: TsSpeedButton;
    SpeedButtonExeHeal: TsSpeedButton;
    SpeedButtonExeKick: TsSpeedButton;
    SpeedButtonExeKill: TsSpeedButton;
    SpeedButtonFastChatDown: TsSpeedButton;
    SpeedButtonFastChatSend: TsSpeedButton;
    SpeedButtonFixIE: TsSpeedButton;
    SpeedButtonGEventReset: TsSpeedButton;
    SpeedButtonGEventRun: TsSpeedButton;
    SpeedButtonGEventState: TsSpeedButton;
    SpeedButtonGiveEP: TsSpeedButton;
    SpeedButtonGiveEPAFK: TsSpeedButton;
    SpeedButtonGiveExp: TsSpeedButton;
    SpeedButtonGiveItems: TsSpeedButton;
    SpeedButtonGiveKit: TsSpeedButton;
    SpeedButtonGiveVehicle: TsSpeedButton;
    SpeedButtonGroupBan: TsSpeedButton;
    SpeedButtonGroupChatSend: TsSpeedButton;
    SpeedButtonGroupEP: TsSpeedButton;
    SpeedButtonGroupHeal: TsSpeedButton;
    SpeedButtonGroupKick: TsSpeedButton;
    SpeedButtonGroupKill: TsSpeedButton;
    SpeedButtonGroupTP: TsSpeedButton;
    SpeedButtonGroupVehicle: TsSpeedButton;
    SpeedButtonKitAdd: TsSpeedButton;
    SpeedButtonKitItemAdd: TsSpeedButton;
    SpeedButtonMap: TsSpeedButton;
    SpeedButtonMenuAbout: TsSpeedButton;
    SpeedButtonMenuAdmins: TsSpeedButton;
    SpeedButtonMenuBans: TsSpeedButton;
    SpeedButtonMenuChat: TsSpeedButton;
    SpeedButtonMenuKits: TsSpeedButton;
    SpeedButtonMenuLog: TsSpeedButton;
    SpeedButtonMenuMain: TsSpeedButton;
    SpeedButtonMenuMonitor: TsSpeedButton;
    SpeedButtonMenuPlayers: TsSpeedButton;
    SpeedButtonMenuQuit: TsSpeedButton;
    SpeedButtonMenuReload: TsSpeedButton;
    SpeedButtonMenuSettings: TsSpeedButton;
    SpeedButtonMenuWeb: TsSpeedButton;
    SpeedButtonMiniChatDown: TsSpeedButton;
    SpeedButtonMiniChatSend: TsSpeedButton;
    SpeedButtonMSGAdd: TsSpeedButton;
    SpeedButtonPCBan: TsSpeedButton;
    SpeedButtonPCKick: TsSpeedButton;
    SpeedButtonPCKill: TsSpeedButton;
    SpeedButtonPCMute: TsSpeedButton;
    SpeedButtonPCPerm: TsSpeedButton;
    SpeedButtonPInfo: TsSpeedButton;
    SpeedButtonPIReSpy: TsSpeedButton;
    SpeedButtonPlayerCtrl: TsSpeedButton;
    SpeedButtonPlayersUpdate: TsSpeedButton;
    SpeedButtonRefreshAdmins: TsSpeedButton;
    SpeedButtonRefreshBans: TsSpeedButton;
    SpeedButtonRefreshDonat: TsSpeedButton;
    SpeedButtonRestart: TsSpeedButton;
    SpeedButtonSetDay: TsSpeedButton;
    SpeedButtonSetNight: TsSpeedButton;
    SpeedButtonSetStorm: TsSpeedButton;
    SpeedButtonShutdown: TsSpeedButton;
    SpeedButtonSNNext: TsSpeedButton;
    SpeedButtonSNPrev: TsSpeedButton;
    SpeedButtonSNRefresh: TsSpeedButton;
    SpeedButtonTP: TsSpeedButton;
    SpeedButtonTPTarget: TsSpeedButton;
    SpeedButtonUEUpdate: TsSpeedButton;
    SpeedButtonUEUpdateVehicles: TsSpeedButton;
    SpeedButtonUnadmin: TsSpeedButton;
    SpeedButtonUnban: TsSpeedButton;
    SpeedButtonVKCon: TsSpeedButton;
    SpeedButtonWBHome: TsSpeedButton;
    SpeedButtonWork: TsSpeedButton;
    ...
    SpeedButtonDonatAdd: TsSpeedButton;
    PanelOnline: TPanel;
    ...
    procedure TableExKitDataDrawCellData(Sender: TObject; ACol, ARow: Integer;
      Rect: TRect; State: TGridDrawState);
    procedure TableExKitsDrawCellData(Sender: TObject; ACol, ARow: Integer;
      Rect: TRect; State: TGridDrawState);
...
const
  ...
  AdminWords:array of string = [
   'админ', 'адмен', 'admin', 'adm', 'адм', 'одмин', 'одмен',
   'хемуль', 'hemul',
   'создатель'];
...
var
  ...
  EventID:Integer;
  //
  MapAddress:string = 'http://hemulgm.ru:27888/';
  SiteAddress:string = 'http://unturned.hemulgm.ru';

  DefBanDuration:Cardinal = inSecondsHour;
  DefBanReason:string     = 'actions';

  PTelegram:^TTelegramBot;
  ChatID:Integer = 357027289;
  BotToken:string = '360193616:AAFJK-C7ntpDX6EAmKW3qOENosPOU2NUtM8';
  ...
  ChatToKick:Word = 0;
  SimpleChatColor:TColor = clSilver;
  DragGPlayerItem:Integer;
  AppPath:string;

  //http://steamcommunity.com/profiles/76561198326392297/?xml=1

implementation
 uses Math, UServer.Memo, HGM.Common.Utils;
...
var ProcMem:PPROCESS_MEMORY_COUNTERS;
  ...
  begin
   ...
   if GetProcessTimes(hProcess, CTime, ETime, KTime, UTime) then
    begin
     ...
     if OKTime = 0 then OKTime:=NKTime;
     if OUTime = 0 then OUTime:=NUTime;
...
begin
 if (X < 0) or (X > ABitmap.Width-1) or (Y < 0) or (Y > ABitmap.Height-1) then Exit; // clipping
...
begin
 ...
 deltay:=abs(y2 - y1);
 if (deltax = 0) or (deltay = 0) then deltax:=1;
...
begin
 if FHearthBeat = 1 then FHearthBeat:=2 else FHearthBeat:=1;
end;
...
begin
 Result:=False;
 if not DirectoryExists(FLocalPath) then Exit;
 if not FileExists(FLocalPath+fileUnturned) then Exit;
 if FileExists(FLocalServerPath+fileCommands) then
  begin
   ...
   try
    ...
    on E:Exception do Log(FLogSystem, 'SetLocalPath '+E.Message);
   end;
   GetCommands(List);
   List.Free;
  end;
...
begin
 ...
 if Result then SteamID:=EditPlayerSteamID.Text;
end;
...
begin
 Result:=PI;
 if Result.IP = '0.0.0.0' then Exit;
  ...
  if XMLDoc.Load('http://api.sypexgeo.net/xml/'+Result.IP) then
   begin
    ...
    for i:=0 to Nodes.Length - 1 do
     case i of
      0:Result.FromCity:=(Nodes.Item[i] as IXMLDOMNode).Text;
      //1:Result.FromCountry:=(Nodes.Item[i] as IXMLDOMNode).Text;
      2:Result.FromCountry:=(Nodes.Item[i] as IXMLDOMNode).Text;
     end;
   end;
 finally
  XMLDoc:=nil;
...
var i, TryInt:Integer;
begin
 Result:=0;
 if Players.Count <= 0 then Exit;
 for i:= 0 to Players.Count-1 do
  begin
   if TryStrToInt(Players[i].Ping, TryInt) then Result:=Result+TryInt;
  end;
 if Result > 0 then Result:=Result div Players.Count;
end;
...
begin
 PID:=-1;
 Result:=False;
 if PlayerInfo.Count <= 0 then Exit;
...
begin
 Result:=SID;
 if GetPlayerInfoID(SID, PID) then Result:=PlayerInfo[PID].CharName;
end;
...
begin
 Result:='Name of '+ID;
 if not TryStrToInt(ID, nID) then Exit;
...
var i: Integer;
begin
 if Players.Count <= 0 then Exit('Нет игроков');
...
begin
 Result:='<пусто>';
 if FLogCommands.Count <= 0 then Exit;
...
begin
 Result:='';
 if FChatList.Count <= 0 then Exit('<пусто>');
...
var Rep:TtgInlineKeyboardMarkup;
...
begin
 ...
 FTelegram.SendMessage(ChatID, 'Управление', TtgParseMode.Markdown, False, False, 0, Rep);
end;
...
begin
 ...
 if (Pos('панель', AnsiLowerCase(Data)) = 1) or
    (Pos('panel', AnsiLowerCase(Data)) = 1) or
    (Pos('control', AnsiLowerCase(Data)) = 1) or
    (Pos('контроль', AnsiLowerCase(Data)) = 1)
 then
  begin
   SendTelegramControl;
   Exit(True);
 ...
 if Pos('/chatlang', Data) = 1 then
  begin
   ...
   else SendTelegram('Чат на русском', True);
   Exit(True);
  end;
...
begin
 ...
 try
  ...
  if CreateProcess(nil, PChar(CommandLine), nil, nil, False, CREATE_NEW_CONSOLE or HIGH_PRIORITY_CLASS, nil, nil, SInfo, FConProcPID) then
   begin
    WaitForInputIdle(FConProcPID.hProcess, ServerRunTimeOut);
    Sleep(ServerRunTimeOut);
    RCONConnect;
    while (not ClientSocket.Active) and (not Application.Terminated) do
     begin
      if FRCONState <> csConnecting then RCONConnect;
...
begin
 ...
 for i:= Max(0, TableExPlayerInfo.ItemIndex+1) to PlayerInfo.Count-1 do
  begin
   if FindText(Text, PlayerInfo[i].SteamID) or
      FindText(Text, PlayerInfo[i].SteamName) or
      FindText(Text, PlayerInfo[i].CharName) or
      FindText(Text, PlayerInfo[i].IP) or
      FindText(Text, PlayerInfo[i].FromCountry) or
      FindText(Text, PlayerInfo[i].FromCity)
   then
    begin
 ...
 if FileExists(ExtractFilePath(Application.ExeName)+'Data\console_answers.dat') then
  begin
   ...
   for i:= 0 to CAF.Count-1 do
    begin
     if Pos(#9, CAF[i]) <> 0 then FConsoleAnswer.Add(CA.Create(Copy(CAF[i], 1, Pos(#9, CAF[i])), Copy(CAF[i], Pos(#9, CAF[i]), 40)));
    end;
   CAF.Free;
  end;
...
begin
 Result:=False;
 if Pos('/a ', ChatRecord.Text) = 1 then
  begin
   ChatRecord.PM:=True;
...
begin
 ...
 if Result then ListBoxExPlayers.ItemIndex:=SID;
end;
 ...
 try
  ...
  while (not Application.Terminated) and (not Thread.Terminated) and (not Thread.Stopping) do
   begin
    ...
    try
     Updates:=PTelegram.getUpdates(MessageOffset, 100, 1000);
    except
     on E:Exception do
      begin
       Thread.Synchronize(
    ...
    if Length(Updates) <= 0 then Continue;
    Thread.Synchronize(
     procedure
      begin
  ...
  on E:Exception do
   begin
    Thread.Synchronize(procedure begin Log(FLogSystem, 'ThreadTelegramWork '+E.Message) end);
  ...
  begin
   ...
   for j:= 0 to PlayerInfo.Count-1 do
    begin
     ...
     if FoundName and FoundJudge then Break;
    end;
  end;
 Bans.UpdateTable;
end;
...
begin
 if Visible then PanelFastChat.Height:=250 else PanelFastChat.Height:=0;
...
begin
 ...
 for i:= 0 to ImageListMed.Count - 1 do ColorImages(ImageListMed, i, ColorDarker(clWhite));
 for i:= 0 to ImageList16.Count - 1 do ColorImages(ImageList16, i, ColorDarker(clWhite));
 cnt:=ImageList24.Count;
 for i:= 0 to cnt - 1 do ImageList24.AddImage(ImageList24, i);
 for i:= cnt to ImageList24.Count - 1 do ColorImages(ImageList24, i, $00FFA319);
end;
 ...
 for i:=0 to PanelMenu.ControlCount - 1 do
  begin
   ...
   if PanelMenu.Controls[i] is TsSpeedButton then
    begin
     (PanelMenu.Controls[i] as TsSpeedButton).Font.Color:=$00AFAFAF;
     if (PanelMenu.Controls[i] as TsSpeedButton).ImageIndex <> -1 then
      (PanelMenu.Controls[i] as TsSpeedButton).ImageIndexHot:=(ImageList24.Count div 2) + (PanelMenu.Controls[i] as TsSpeedButton).ImageIndex;
    end;
  end;
...
begin
 case PBP of
  pbpNone:  IM.StyledColor($00A0A0A0);
  pbpWork:  IM.StyledColor($0005D3E4);
  pbpError: IM.StyledColor($000241E8);
  pbpOK:    IM.StyledColor($0002C883);
 end;
 Application.ProcessMessages;
end;
...
begin
 ...
 if GetPlayerInfoID(SteamID, PID) then SteamID:=PlayerInfo[PID].CharName;
 if AnsiLowerCase(Reason) = 'raid' then Reason:='рейд';
 if AnsiLowerCase(Reason) = 'cheat' then Reason:='читы';   
 if AnsiLowerCase(Reason) = 'actions' then Reason:='поведение';
 //Сообщить игрокам
...
begin
  ...
  begin
   if ChatRec.Text.Length > 0 then
    begin
     if ChatRec.Text[1] <> '/' then
      begin
       ...
       if (ChatRec.Player.SteamID = LastChatRec.Player.SteamID) and (ChatRec.Text = LastChatRec.Text) then
        begin
         ChatToKick:=ChatToKick + 1;
         if ChatToKick > ChatDblToKick then
          begin
           ChatToKick:=0;
     ...
     else if UserCommandProc(ChatRec) then Exit;
     //Ответить игроку
 ...
 if (ChatRec.From <> cfSite) and (ChatRec.Around = caWorld) then WorldChatToSite(ChatRec);
end;
...
begin
 ...
 if DirectoryExists(FLocalPath) then
  if FUExplorer.Outdated then FNotify.Warning('Обновите базу предметов!', 'Внимание');
...
begin
 ...
 if Data.PlayerGameName.IsEmpty then Data.PlayerGameName:=Data.PlayerSteamID;
...
begin
 ...
 if Data.IndexOf('Admins:') <> 0 then Exit;
 Admin.JudgeSteamID:='';
 Admin.PlayerSteamID:='';
 Admins.BeginUpdate;
 Admins.Clear;
   ...
   if Pos('Reason: ', Data.Strings[i]) = 1 then
    begin
     try
      ...
      if not TryStrToInt64(SubEvent, tryint) then Ban.Duration:=0
      else Ban.Duration:=tryint;

      SubEvent:=Copy(Data.Strings[i], Pos('Remaining: ', Data.Strings[i])+11, 200);
      SubEvent:=Copy(SubEvent, 1, 50);
      if not TryStrToInt64(SubEvent, tryint) then Ban.Remaining:=0 else Ban.Remaining:=tryint;
      Bans.Add(Ban);
      Ban.PlayerSteamName:='';
      Ban.PlayerGameName:='';
      Ban.PlayerSteamID:='';
...
begin
 ...
 for i:=1 to Data.Count - 1 do
  begin
   ...
   else Log(FLogRCON, 'Упс, чет не моё: '+Data.Strings[i]);
  end;
 Players.EndUpdate;
 FUpdatePlayerList;
 if MainManager then ExecuteCommand.GetBans;
 {
 Players:
...
begin
 ...
 else Log(FLogRCON, 'Упс, чёт не моё: '+Data);

 if IsCon then OnPlayerConnect(Player) else OnPlayerDisconnect(Player);
end;
...
begin
 ...
 if (Pos('Successfully permabanned', Data) = 1) or
    (Pos('Successfully unbanned', Data) = 1)
 then ExecuteCommand.GetBans;
end;
...
var Param, tmp, v1, v2, v3, v4, v5:string;
    i, v:Integer;
    coll:Boolean;
begin
 ...
 if Param = 'NOW' then
  begin
   IsDay:= v1 = '1';
   IsFullMoon:= v2 = '1';
   if TryStrToInt(v3, i) then TimeOnServer:=i;
  end;
end;
...
begin
 ...
 if i > 0 then
  begin
   ...
   if tmp = 'World' then ChatRec.Around:=caWorld
   else
    if tmp = 'Area' then ChatRec.Around:=caArea
    else
    if tmp = 'Group' then ChatRec.Around:=caGroup
    else ChatRec.Around:=caWorld;
  ...
  begin
   ...
   while MSGData.Count > 0 do
    begin
     ...
     //Чат
     if (Pos('[World]', Buf) = 1) or (Pos('[Area]',  Buf) = 1) or (Pos('[Group]', Buf) = 1)
     then
      begin
       ProcChat(Buf);
       if Next then Continue;
     ...
     //Disconnecting: PlayerID: 76561198123840535 Name: سأقتلك Character: top
     if (Pos('Disconnecting: ', Buf) = 1) or (Pos('Connecting: ', Buf) = 1)
     then
      begin
       ProcPlayerState(Buf);
       if Next then Continue;
     ...
     if Pos('Players:', Buf) = 1 then
      begin
       if CurEvent <> '' then ProcessMSG('END');
       CurEvent:=Buf;
       ProcData.Clear;
       ProcData.Add(Buf);
       j:=i;
     ...
     if CurEvent = 'Players:' then
      begin
       if (Pos('PlayerID: ', MSGData[i]) = 1)
       then
        begin
         ProcData.Add(MSGData[i]);
         if Next then Continue;
        end;
      end;
     //Список банов
     ...
     if CurEvent = 'Bans:' then
      begin
       if (Pos('PlayerID: ', MSGData[i]) = 1) or
          (Pos('JudgeID: ', MSGData[i]) = 1) or
          (Pos('Reason: ', MSGData[i]) = 1)
       then
        begin
         ProcData.Add(MSGData[i]);
         if Next then Continue;
     ...
     if CurEvent = 'Admins:' then
      begin
       if (Pos('PlayerID: ', MSGData[i]) = 1) or
          (Pos('JudgeID: ', MSGData[i]) = 1)
       then
        begin
         ProcData.Add(MSGData[i]);
         if Next then Continue;
     ...
     if Buf = 'END' then
      begin
       ...
       if CurEvent = 'Players:' then ProcPlayers(ProcData) else
        if CurEvent = 'Admins:' then ProcAdmins(ProcData) else
         if CurEvent = 'Bans:'  then ProcBans(ProcData);
       CurEvent:='';
       ProcData.Clear;
       if Next then Continue;
      end;
...
begin
 ...
 case StartCommands.PVMode of
  modePVP: EditSCPVMode.Text:='PvP';
  modePVE: EditSCPVMode.Text:='PvE';
 end;
...
begin
 ...
 Value:=Trim(Value);
 i:=Pos(' ', Value);
 if i <> 0 then TryStrToInt(Copy(Value, i+1, 20), Result);
end;
...
begin
 ...
 Value:=Trim(Value);
 i:=Pos(' ', Value);
 if i <> 0 then Result:=Copy(Value, i+1, 200);
end;
...
begin
 ...
 begin
  if not Assigned(FUpdate) then Exit;
  if Assigned(FUpdate.Message) then
   begin
    TextData:=FUpdate.Message.Text;
    if TextData.IsEmpty then Exit;
    if HandleTelegram(TextData) then Exit else TelegramTimerReset;
    Chat(cfAdmin, TextData);
   end
  else
   if Assigned(FUpdate.CallbackQuery) then
    begin
     if AnsiLowerCase(FUpdate.CallbackQuery.Data) = 'lastchat' then SendTelegram(GetLastChat(20), True);
     if AnsiLowerCase(FUpdate.CallbackQuery.Data) = 'players' then SendTelegram(GetPlayers, True);
     if AnsiLowerCase(FUpdate.CallbackQuery.Data) = 'lastlog' then SendTelegram(GetLastLog(20), True);
     if AnsiLowerCase(FUpdate.CallbackQuery.Data) = 'stop' then StopTelegram;
        ...
        begin
         if FileExists(AppPath+'\lastscreen.png') then
          begin
           ...
           try
            FTelegram.SendPhoto(ChatID, LFile, 'Скрин');
           finally
            LFile.Free;
           end;
          end;
        end
       else SendTelegram('Ошибка при создании снимка', True);
      end;
    end;
 end;
end;
...
begin
 ...
 try
  ...
  on E:Exception do Log(FLogSystem, 'CreateSelfie '+E.Message);
 end;
 PNG.Free;
end;
...
begin
 ...
 if Players.Count <= 0 then Exit;
 for i:= 0 to Players.Count-1 do Items.Add(Players[i].SteamID);
end;
...
begin
 ...
 if AutoMove then TableExMiniChat.ItemIndex:=TableExMiniChat.ItemCount - 1;

 AutoMove:=TableExFastChat.ItemIndex = TableExFastChat.ItemCount - 1;
 TableExFastChat.ItemCount:=ChatList.Count;
 if AutoMove then TableExFastChat.ItemIndex:=TableExFastChat.ItemCount - 1;
end;

procedure TFormMain.FUpdateKitData;
begin
 if (FSelKit < 0) or (not IndexInList(FSelKit, FKits.Count)) then TableExKitData.ItemCount:=0
 else TableExKitData.ItemCount:=FKits[FSelKit].Count;
...
begin
 ...
 for i:= 0 to FKits.Count-1 do ComboBoxGiveKit.Items.Add(FKits[i].KitName);
end;
...
begin
 ...
 else Indicate(LabelExConDBU, pbpOK);
end;
...
begin
 ...
 else Indicate(LabelExConDBS, pbpOK);
end;

procedure TFormMain.ConnectVK;
begin
 Indicate(LabelExConVK, pbpWork);
 if FVKGroup.Open(FVKUser, FVKPass, FVKGID) then Indicate(LabelExConVK, pbpOK)
 else Indicate(LabelExConVK, pbpError);
end;
...
begin
 ...
 if EvId >= FGameEventManager.EventCount then Exit;
 with DrawGridTimers.Canvas do
  begin
   if (ACol = DrawGridTimers.Col) and (ARow = DrawGridTimers.Row) then Brush.Color:=$00666666;
 ...
 if FActive then Color1:=clHighlight else Color1:=$002FD5ED;
...
begin
 ...
 with ListBoxExPlayers.Canvas do
  begin
   FColor:=clSilver;
   if Players.Count > 0 then Player:=Players[ARow]
   else
    begin
     Font.Color:=FColor;
...
begin
 if FileExists(FLocalServerPath+'\Spy\'+SID+'.jpg') then
  ...
  else ImageSpay.Picture.Assign(nil);
end;
  ...
  begin
   ...
   if ID < Players.Count then
    begin
     ...
     SetPlayerInfo(Data);
     if PageControl.ActivePage = TabSheetDBPlayersInfo then FindAndSelPlayerInfo(Players[ID].SteamID);
     if PageControl.ActivePage = TabSheetDBBans        then FindAndSelBanned(Players[ID].SteamID);
     if PageControl.ActivePage = TabSheetDBAdmins      then FindAndSelAdmin(Players[ID].SteamID);
    end;
  end;
...
begin
 if ssCtrl in Shift then ListBoxExPlayers.BeginDrag(False);
end;

procedure TFormMain.ListBoxExPlayersStartDrag(Sender: TObject; var DragObject: TDragObject);
var Col:Integer;
begin
 ListBoxExPlayers.MouseToItem(ListBoxExPlayers.ScreenToClient(Mouse.CursorPos), DragGPlayerItem, Col);
end;
...
begin
 if ClientSocket.Active then RCONClose;
...
begin
 case Key of
  VK_UP:PrevMessage(EditSendChatFast);
  VK_DOWN:NextMessage(EditSendChatFast);
 else Exit;
 end;
 Key:=0;
end;
...
begin
 ...
 if EditSendChatFast.Text = '' then SendedMessages.ResetCur;
end;

procedure TFormMain.EditTPPlaceDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
 if Source = ListBoxExPlayers then SpeedButtonTPTargetClick(nil);
end;
...
begin
 if not PlayerInfoSearch(EditPISearch.Text) then
  if PlayerInfo.Count > 0 then TableExPlayerInfo.ItemIndex:=0;
end;
...
begin
 case Key of
  VK_UP:PrevMessage(EditChatSend);
  VK_DOWN:NextMessage(EditChatSend);
 else Exit;
 end;
 Key:=0;
end;
...
begin
 ...
 if EditChatSend.Text = '' then SendedMessages.ResetCur;
end;
...
begin
 ...
 if EditCommandSend.Text = '' then ExecutedCommands.ResetCur;
end;
...
begin
 case Key of
  VK_UP:PrevMessage(EditMiniChatSend);
  VK_DOWN:NextMessage(EditMiniChatSend);
 else Exit;
 end;
 Key:=0;
end;
...
begin
 ...
 if EditMiniChatSend.Text = '' then SendedMessages.ResetCur;
end;

procedure TFormMain.EditPlayerSteamIDChange(Sender: TObject);
begin
 if EditPlayerSteamID.Text = '' then PanelPlayerCtrlHide;
end;
...
begin
 ...
 if FileExists(FileName) then Append(Text) else Rewrite(Text);
 Writeln(Text, Value);
 CloseFile(Text);
end;
...
begin
 ...
 if Dest = FLogRCON then WriteToFile(AppPath+'Logs\'+LogNameRCON, Value);
 if Dest = FLogCommands then WriteToFile(AppPath+'Logs\'+LogNameCommands, Value);
 if Dest = FLogGamePlay then WriteToFile(AppPath+'Logs\'+LogNameGameplay, Value);
 if Dest = FLogSystem then WriteToFile(AppPath+'Logs\'+LogNameSys, Value);
end;
...
begin
 if FindAndSelPlayerInfo(FPopupChatRecord.Player.SteamID) then SetPage(TabSheetDBPlayersInfo);
end;
...
begin
 if GetCurrentPlayerSteamID(SID) then
  begin
   if MessageBox(Application.Handle, PWideChar('Отправить в бан на 1 год игрока '+GetCurrentPlayerName+'?'), 'Внимание', MB_ICONWARNING or MB_YESNO or MB_DEFBUTTON2) <> ID_YES then Exit;
...
var Cmd:string;
begin
 if ExecutedCommands.GetNext(Cmd) then EditCommandSend.Text:=Cmd;
...
var Text:string;
begin
 if SendedMessages.GetNext(Text) then Edit.Text:=Text;
...
var Cmd:string;
begin
 if ExecutedCommands.GetPrev(Cmd) then EditCommandSend.Text:=Cmd;
 EditCommandSend.SelStart:=Length(EditCommandSend.Text);
end;
...
var Text:string;
begin
 if SendedMessages.GetPrev(Text) then Edit.Text:=Text;
 Edit.SelStart:=Length(Edit.Text);
end;
...
begin
 Log(FLogRCON, Text);
 if FormMain.ClientSocket.Active then ClientSocket.Socket.SendText(Text+CRLF);
end;
...
begin
 if not MainManager then Exit;
 if not Force then
  if TelegramIsTimed then if TelegramTimer <= 0 then Exit;
 try
  if MessageText = '' then Exit;
  FTelegram.SendMessage(ChatID, MessageText);
 except
  on E:Exception do Log(FLogSystem, 'SendTelegram '+E.Message);
 end;
end;
...
begin
 FRCONState:= Value;
 case FRCONState of
  csNone:Indicate(LabelExConRCON, pbpNone);
  csConnected:Indicate(LabelExConRCON, pbpOk);
  csConnecting:Indicate(LabelExConRCON, pbpWork);
  csDisconnected:Indicate(LabelExConRCON, pbpError);
 end;
end;
...
begin
 if ColorDialog.Execute(Handle) then ChatColor:=ColorDialog.Color;
end;
...
begin
 if TableExChat.ItemCount > 0 then TableExChat.ItemIndex:=TableExChat.ItemCount-1;
...
var SID:TSteamID;
begin
 if not IndexInList(ComboBoxChatFilter.ItemIndex, FChatPlayers.Count) then Exit;
...
begin
 if EditChatSend.Text = '' then Exit;
...
begin
 if MessageBox(Application.Handle, 'Вы дейстивтельно хотите очистить Cookies и кэш браузера?', 'Внимание', MB_ICONWARNING or MB_YESNO) <> ID_YES then Exit;
 DeleteIECache;
end;
...
var SID:TSteamID;
    ...
    TInt:Integer;
begin
 if not GetCurrentPlayerSteamID(SID) then Exit;
 if GetPlayerInfoID(SID, TInt) then
  Donat.Player:=PlayerInfo[Tint].GetPlayerData
 else Donat.Player.SteamID:=SID;
 case ComboBoxDonatGroup.ItemIndex of
  0: Donat.Group:=PermGroupModer;
  1: Donat.Group:=PermGroupVIP;
 else Donat.Group:=PermGroupModer; 
 end;
 Donat.DateBegin:=Now;
 case ComboBoxDonatTime.ItemIndex of
  0: Donat.Days:=7;
  1: Donat.Days:=30;
 else if TryStrToInt(ComboBoxDonatTime.Text, TInt) then Donat.Days:=TInt else Exit;
 end;

 if not Ask('Вы хотите выдать игроку '+Donat.Player.GameName+' временные привилегии на '+GetWithWord(twDays, Donat.Days)+'?') then Exit;
...
begin
 ...
 if not IndexInList(ID, FDonats.Count) then Exit;
 if not Ask('Деактивировать выбранный донат?') then Exit;
...
begin
 ID:=TableExDonat.ItemIndex;
 if not IndexInList(ID, FDonats.Count) then Exit;
 if FServerDB.DeleteDonat(FDonats[ID].ID) then FDonats.Delete(ID);
end;
...
begin
 ...
 if Data.Unlimit then
  begin
   if not Ask('Убрать метку "Бессрочный"?') then Exit;
   Data.Unlimit:=False;
  end
 else
  begin
   if not Ask('Поставить метку "Бессрочный"?') then Exit;
   Data.Unlimit:=True;
  end;
...
begin
 if TableExPlayersRev.ItemCount > 0 then TableExPlayersRev.ItemIndex:=TableExPlayersRev.ItemCount-1;
...
begin
 if not GetCurrentPlayerSteamID(SID) then Exit;
 if FormBan.ShowModal <> mrOk then Exit;
 if (FormBan.EditReason.ItemIndex >=0) and (FormBan.EditReason.ItemIndex < Length(BanReasons)) 
 then Reason:=BanReasons[FormBan.EditReason.ItemIndex]
 else Reason:=DefBanReason;
...
var SID:string;
begin
 if not CheckUseCommandForAll then Exit;
 if UseCommandForAll then ExecuteCommand.HealAll
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.Heal(SID);
...
begin
 if not CheckUseCommandForAll then Exit;
 if UseCommandForAll then ExecuteCommand.KickAll('')
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.Kick(SID, '');
 UseCommandForAll:=False;
end;
...
begin
 if not CheckUseCommandForAll then Exit;
 if UseCommandForAll then ExecuteCommand.KillAll
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.Kill(SID);
 UseCommandForAll:=False;
end;

procedure TFormMain.SpeedButtonFastChatDownClick(Sender: TObject);
begin
 if TableExFastChat.ItemCount > 0 then TableExFastChat.ItemIndex:=TableExFastChat.ItemCount-1;
 TableExFastChat.Perform(WM_VSCROLL, SB_BOTTOM, 0);
end;

procedure TFormMain.SpeedButtonFastChatSendClick(Sender: TObject);
begin
 if EditSendChatFast.Text = '' then Exit;
 ...
 if Reg.OpenKey('SOFTWARE\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_BROWSER_EMULATION', True) then
  begin
   try
    ...
    on E:Exception do Log(FLogSystem, 'SpeedButtonFixIEClick '+E.Message);
   end;
  end;
 Reg.CloseKey;
 Reg.Free;
...
var SID:string;
    Amount:Integer;
begin
 if not TryStrToInt(EditGiveEP.Text, Amount) then if Warning('Проверьте данные поля "Кол-во EP"') then Exit;
 if GetCurrentPlayerSteamID(SID) then
...
begin
 if not CheckUseCommandForAll then Exit;
 if not TryStrToInt(EditGiveEP.Text, Amount) then if Warning('Проверьте данные поля "Кол-во EP"') then Exit;
 if UseCommandForAll then ExecuteCommand.GiveMoneyAll(Amount)
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.GiveMoney(SID, Amount);
 UseCommandForAll:=False;
end;
...
begin
 if not CheckUseCommandForAll then Exit;
 if not TryStrToInt(EditGiveExp.Text, Amount) then if Warning('Проверьте данные поля "Кол-во опыта"') then Exit;
 if UseCommandForAll then ExecuteCommand.GiveExpirienceAll(Amount)
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.GiveExpirience(SID, Amount);
 UseCommandForAll:=False;
end;
...
begin
 ...
 if UseCommandForAll then ExecuteCommand.GiveItemsAll(Items, Amount)
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.GiveItems(SID, Items, Amount);
 Items.Free;
 UseCommandForAll:=False;
end;
...
begin
 if not CheckUseCommandForAll then Exit;
 if not IndexInList(ComboBoxGiveKit.ItemIndex, FKits.Count) then Exit;
 ...
 for i:=0 to FKits[ComboBoxGiveKit.ItemIndex].Count-1 do
  begin
   ...
   if UseCommandForAll then ExecuteCommand.GiveItemAll(Item, Amount)
   else
    if GetCurrentPlayerSteamID(SID) then ExecuteCommand.GiveItem(SID, Item, Amount);
  end;
...
var i:Integer;
begin
 if EditGroupChatSend.Text = '' then Exit;
...
begin
 if TableExMiniChat.ItemCount > 0 then TableExMiniChat.ItemIndex:=TableExMiniChat.ItemCount-1;
...
var SID:TSteamID;
begin
 if EditMiniChatSend.Text = '' then Exit;
 if CheckBoxMiniChatPM.Checked then
  ...
  else CheckBoxMiniChatPM.Checked:=False;
...
begin
 if GetCurrentPlayerSteamID(SID) then
  begin
   if not Ask('Кикнуть игрока "'+GetPlayerName(SID)+'"?') then Exit;
...
begin
 if GetCurrentPlayerSteamID(SID) then
  begin
   if not Ask('Убить игрока "'+GetPlayerName(SID)+'"?') then Exit;
...
begin
 if GetCurrentPlayerSteamID(SID) then
  begin
   if not Ask('Запретить игроку "'+GetPlayerName(SID)+' писать в чат"?') then Exit;
...
var SID:String;
begin
 if GetCurrentPlayerSteamID(SID) then if FindAndSelPlayerInfo(SID) then SetPage(TabSheetDBPlayersInfo);
end;
...
begin
 if EditPlayerSteamID.Text = '' then Exit;
...
begin
 try
  ...
  on E:Exception do Log(FLogSystem, E.Message);
 end;
end;
...
begin
 if not CheckUseCommandForAll then Exit;
 if UseCommandForAll then ExecuteCommand.TeleportAll(EditTPPlace.Text)
 else
  if GetCurrentPlayerSteamID(SID) then ExecuteCommand.Teleport(SID, EditTPPlace.Text);
 UseCommandForAll:=False;
end;
...
var SID:String;
begin
 if GetCurrentPlayerSteamID(SID) then EditTPPlace.Text:=SID;
end;

procedure TFormMain.SpeedButtonMenuWebClick(Sender: TObject);
var SID:String;
begin
 if GetCurrentPlayerSteamID(SID) then ShowSteamInfo(SID)
 else WebBrowserInfo.Navigate(SiteAddress);
 SetPage(TabSheetSteamInfo);
end;
...
begin
 ...
 Log(FLogSystem, 'Сохранение параметров'); Application.ProcessMessages;
 SettingsSave;

 Log(FLogSystem, 'Остановка таймеров'); Application.ProcessMessages;
 TimerUpdate.Enabled:=False;
 TimerCheckDonat.Enabled:=False;

 Log(FLogSystem, 'Закрытие соединения с RCON'); Application.ProcessMessages;
 RCONClose;

 Log(FLogSystem, 'Закрытие соединения с БД сервера'); Application.ProcessMessages;
 FServerDB.Disconnect;

 Log(FLogSystem, 'Закрытие соединения с БД сайта'); Application.ProcessMessages;
 FSiteDB.Disconnect;

 Log(FLogSystem, 'Завершение работы потоков'); Application.ProcessMessages;
 if FThreadTelegram.Started       then FThreadTelegram.Stop;
 if FThreadUpdatePlayers.Started  then FThreadUpdatePlayers.Stop;
 if FThreadChatSendToGame.Started then FThreadChatSendToGame.Stop;
 if FThreadGetServer.Started      then FThreadGetServer.Stop;
 if FThreadProcInfo.Started       then FThreadProcInfo.Stop;

 Log(FLogSystem, 'Ожидание завершения работы потоков'); Application.ProcessMessages;
 ...
 Log(FLogSystem, 'Завершение работы'); Application.ProcessMessages;
...
begin
 ...
 if not IndexInList(ID, Admins.Count) then Exit;
...
begin
 ...
 if not IndexInList(ID, Bans.Count) then Exit;
...
begin
 if PanelPlayerCtrlVisible then PanelPlayerCtrlHide else PanelPlayerCtrlShow;
end;

procedure TFormMain.TableExActionsEdit(Sender: TObject; var Data: TTableEditStruct; ACol, ARow: Integer; var Allow: Boolean);
begin
 if not IndexInList(ARow, FServerActions.Count) then Exit;
 if FServerActions[ARow].SteamID <> '' then
  if FindAndSelPlayerInfo(FServerActions[ARow].SteamID) then SetPage(TabSheetDBPlayersInfo);
end;
...
begin
 ...
 if not IndexInList(FRow, FServerActions.Count) then Exit;
 case FCol of
  0:Value:=HumanDateTime(FServerActions[FRow].Date);
  1:Value:=FServerActions[FRow].Data;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, Admins.Count) then Exit;
 case FCol of
  0:Value:=Admins[FRow].PlayerSteamID;
  1:Value:=Admins[FRow].PlayerSteamName;
  2:Value:=Admins[FRow].PlayerGameName;
  3:Value:=Admins[FRow].JudgeGameName;
 end;
end;
...
var PID:Integer;
begin
 if not IndexInList(Index, Admins.Count) then Exit;
 if GetPlayerInfoID(Admins[Index].PlayerSteamID, PID) then SetPlayerInfo(PlayerInfo[PID]);
...
begin
 ...
 if not IndexInList(FRow, Bans.Count) then Exit;
 case FCol of
  0:Value:=Bans[FRow].PlayerSteamID;
  1:Value:=Bans[FRow].PlayerSteamName;
  2:Value:=Bans[FRow].PlayerGameName;
  3:Value:=Bans[FRow].JudgeGameName;
  4:Value:=Bans[FRow].Reason;
  5:Value:=IntToStr(Bans[FRow].Duration div 3600)+' ч.';
  6:Value:=IntToStr(Bans[FRow].Remaining div 3600)+' ч.';
 end;
end;
...
var PID:Integer;
begin
 if not IndexInList(Index, Bans.Count) then Exit;
 if GetPlayerInfoID(Bans[Index].PlayerSteamID, PID) then SetPlayerInfo(PlayerInfo[PID]);
...
var Chat:TChatRecord;
begin
 if not IndexInList(ARow, FChatBase.Count) then Exit;
 with (Sender as TTableEx).Canvas do
  begin
   if ACol <> 0 then Exit;
   if FChatBase.Count > 0 then Chat:=FChatBase[ARow] else Exit;

   if Chat.PM then ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top+Rect.Height div 2 - 16 div 2, 28)
   else
   case Chat.Around of
    caGroup: ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top+Rect.Height div 2 - 16 div 2, 14); //14
    caArea: ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top+Rect.Height div 2 - 16 div 2, 12);  //12
    caWorld: ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top+Rect.Height div 2 - 16 div 2, 13); //13
   end;
  end;
end;
...
begin
 ...
 Allow:=True;
 case ACol of
  1:Data.TextValue:=FChatBase[ARow].Player.GameName;
  2:Data.TextValue:=FChatBase[ARow].Text;
  3:Data.TextValue:=HumanDateTime(FChatBase[ARow].Date);
 else Allow:=False;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, FChatBase.Count) then Exit;
 case FCol of
  1:Value:=FChatBase[FRow].Player.GameName;
  2:Value:=FChatBase[FRow].Text;
  3:Value:=HumanDateTime(FChatBase[FRow].Date);
 end;
end;

procedure TFormMain.TableExChatItemClick(Sender: TObject; MouseButton: TMouseButton; const Index: Integer);
begin
 if IndexInList(Index, FChatBase.Count) then FindAndSelOnlineName(FChatBase[Index].Player.GameName);
end;
...
begin
 if Button = mbRight then
  begin
   ...
   if not IndexInList(ID, FChatBase.Count) then Exit;
...
begin
 ...
 if not IndexInList(FRow, FDonats.Count) then Exit;
 case FCol of
  1:Value:=FDonats[FRow].Player.SteamName+' ('+FDonats[FRow].Player.GameName+')';
  2:Value:=FDonats[FRow].Group;
  3:Value:=HumanDateTime(FDonats[FRow].DateBegin);
  4:
   begin
    if FDonats[FRow].Unlimit then Value:='Бессрочный'
    else Value:=HumanDateTime(FDonats[FRow].DateEnd);
   end;
  5:Value:=IFELSESTR(FDonats[FRow].Active, 'Активно', '');
 end;
end;
...
begin
 if IndexInList(Index, FDonats.Count) then
  begin
   if GetPlayerInfoID(FDonats[Index].Player.SteamID, PID) then SetPlayerInfo(PlayerInfo[PID]);
...
begin
 with (Sender as TTableEx).Canvas do
  begin
   if ACol <> 0 then Exit;
   if not IndexInList(ARow, ChatList.Count) then Exit;
   Chat:=ChatList[ARow];
...
begin
 ...
 if ACol = 0 then
  begin
   if Sender = TableExMiniChat then EditMiniChatSend.Text:=ChatList[ARow].Player.GameName+', '+EditMiniChatSend.Text;
   if Sender = TableExFastChat then EditSendChatFast.Text:=ChatList[ARow].Player.GameName+', '+EditSendChatFast.Text;
   Exit;
  end;
 Data.EditMode:=teText;
 Data.ReadOnly:=True;
 Allow:=True;
 case ACol of
  1:Data.TextValue:=ChatList[ARow].Player.GameName;
  2:Data.TextValue:=ChatList[ARow].Text;
  3:Data.TextValue:=HumanDateTime(ChatList[ARow].Date);
 else Allow:=False;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, ChatList.Count) then Exit;
 case FCol of
  1:Value:=ChatList[FRow].Player.GameName;
  2:Value:=ChatList[FRow].Text;
 end;
end;

procedure TFormMain.TableExGroupPlayersDragDrop(Sender, Source: TObject; X, Y: Integer);
var Item, Col:Integer;
begin
 if Source = Sender then
  begin
   if not IndexInList(DragGPlayerItem, FGroupPlayers.Count) then Exit;
   TableExGroupPlayers.MouseToItem(Point(X, Y), Item, Col);
   if IndexInList(Item, FGroupPlayers.Count) then
    begin
     FGroupPlayers.Move(DragGPlayerItem, Item);
     TableExGroupPlayers.ItemIndex:=Item;
    end
   else
    begin
     FGroupPlayers.Move(DragGPlayerItem, FGroupPlayers.Count-1);
 ...
 if Source = ListBoxExPlayers then
  begin
   if not IndexInList(DragGPlayerItem, FPlayers.Count) then Exit;
   TableExGroupPlayers.MouseToItem(Point(X, Y), Item, Col);
   if IndexInList(Item, FGroupPlayers.Count)
   then FGroupPlayers.Insert(Item, FPlayers[DragGPlayerItem])
   else Item:=FGroupPlayers.Add(FPlayers[DragGPlayerItem]);
   TableExGroupPlayers.ItemIndex:=Item;
  end;
end;
...
begin
 ...
 if not IndexInList(FRow, FGroupPlayers.Count) then Exit;
 case FCol of
  0:Value:=IntToStr(FRow+1);
  1:Value:=FGroupPlayers[FRow].GameName+' ('+FGroupPlayers[FRow].SteamName+')';
  2:Value:='Удалить';
 end;
end;
...
begin
 if not IndexInList(TableExGroupPlayers.ItemIndex, FGroupPlayers.Count) then Exit;
 case Index of
  2:
   begin
...
begin
 ...
 if (not IndexInList(FSelKit, FKits.Count)) or (FKits.Count = 0) then
  begin
   Value:='';
   if FCol = 3 then Value:='Пусто';
   Exit;
  end;
 if not IndexInList(FRow, FKits[FSelKit].Count) then Exit;

 case FCol of
  //0:Value:=IntToStr(FRow+1);
  2:Value:=FKits[FSelKit][FRow].ID;  
  3:Value:=GetUnturnedItemID(FKits[FSelKit][FRow].ID);
  4:Value:=IntToStr(FKits[FSelKit][FRow].Count);    
  5:Value:='Удалить';
 end;
end;
...
begin
 if not IndexInList(FSelKit, FKits.Count) then Exit;
 if not IndexInList(TableExKitData.ItemIndex, FKits[FSelKit].Count) then Exit;
 case Index of
  5:
   begin
...
begin
 ...
 Allow:=True;
 case ACol of
  1:Data.TextValue:=FKits[ARow].KitName;
 else Allow:=False;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, Kits.Count) then Exit;
 case FCol of
  //0:Value:=IntToStr(FRow+1);
  1:Value:=Kits[FRow].KitName;
  2:Value:=IntToStr(Kits[FRow].Count);  
  3:Value:='Удалить';
 end;
end;
...
begin
 if not IndexInList(TableExKits.ItemIndex, FKits.Count) then Exit;
 case Index of
  3:
   begin                 
...
begin
 ...
 if not IndexInList(FRow, FMapPlaces.Count) then Exit;
 case FCol of
  0:Value:=FMapPlaces[FRow].Desc;
 end;
end;

procedure TFormMain.TableExMapPointsItemClick(Sender: TObject; MouseButton: TMouseButton; const Index: Integer);
begin
 if IndexInList(Index, FMapPlaces.Count) then EditTPPlace.Text:=FMapPlaces[Index].Name;
end;
...
begin
 ...
 case FCol of
  1:Value:=ChatList[FRow].Player.GameName;
  2:Value:=ChatList[FRow].Text;
  3:Value:=FormatDateTime('HH:NN:SS', ChatList[FRow].Date);
 end;
end;

procedure TFormMain.TableExMiniChatItemClick(Sender: TObject; MouseButton: TMouseButton; const Index: Integer);
begin
 if IndexInList(Index, ChatList.Count) then FindAndSelOnlineName(ChatList[Index].Player.GameName);
end;
...
begin
 if Button = mbRight then
  begin
   ...
   if not IndexInList(ID, ChatList.Count) then Exit;
...
begin
 if not IndexInList(ARow, FGameMessages.Count) then Exit;
 with TableExMSG.Canvas do
  begin
   ...
   if (ACol = 1) and (ARow = FGameMessages.CurrentMessage) then ImageList16.Draw(TableExMSG.Canvas, Rect.Left + Centred(Rect.Width, ImageList16.Width), Rect.Top + Centred(Rect.Height, ImageList16.Width), 9, True);
  end;
end;
...
begin
 ...
 Allow:=True;
 case ACol of
  2:Data.TextValue:=FGameMessages[ARow].Text;
  3:
   begin
...
begin
 ...
 if not IndexInList(FRow, FGameMessages.Count) then Exit;

 case FCol of
  0:Value:=IntToStr(FRow+1);
  2:Value:=FGameMessages[FRow].Text;
  4:Value:='Удалить';
 end;
end;
...
begin
 ...
 if not IndexInList(ID, FGameMessages.Count) then Exit;
 case Index of
  4:
   begin
...
begin
 case Index of
  0:if PIOrderBy = fieldPI_SteamID+' ASC'         then PIOrderBy:=fieldPI_SteamID+' DESC'         else PIOrderBy:=fieldPI_SteamID+' ASC';
  1:if PIOrderBy = fieldPI_SteamName+' ASC'       then PIOrderBy:=fieldPI_SteamName+' DESC'       else PIOrderBy:=fieldPI_SteamName+' ASC';
  2:if PIOrderBy = fieldPI_CharName+' ASC'        then PIOrderBy:=fieldPI_CharName+' DESC'        else PIOrderBy:=fieldPI_CharName+' ASC';
  3:if PIOrderBy = fieldPI_IP+' ASC'              then PIOrderBy:=fieldPI_IP+' DESC'              else PIOrderBy:=fieldPI_IP+' ASC';
  4:if PIOrderBy = fieldPI_LastLoginGlobal+' ASC' then PIOrderBy:=fieldPI_LastLoginGlobal+' DESC' else PIOrderBy:=fieldPI_LastLoginGlobal+' ASC';
  5:if PIOrderBy = fieldPI_TotalPlayTime+' ASC'   then PIOrderBy:=fieldPI_TotalPlayTime+' DESC'   else PIOrderBy:=fieldPI_TotalPlayTime+' ASC';
  6:if PIOrderBy = fieldPI_FromCountry+' ASC, '+fieldPI_FromCity+' DESC' then PIOrderBy:=fieldPI_FromCountry+' DESC, '+fieldPI_FromCity+' DESC' else PIOrderBy:=fieldPI_FromCountry+' ASC, '+fieldPI_FromCity+' ASC';
  7:if PIOrderBy = fieldPI_RegDate+' ASC'         then PIOrderBy:=fieldPI_RegDate+' DESC'         else PIOrderBy:=fieldPI_RegDate+' ASC';
  8:if PIOrderBy = fieldPI_Balance+' ASC'         then PIOrderBy:=fieldPI_Balance+' DESC'         else PIOrderBy:=fieldPI_Balance+' ASC';
  9:if PIOrderBy = fieldPI_Score+' ASC'           then PIOrderBy:=fieldPI_Score+' DESC'           else PIOrderBy:=fieldPI_Score+' ASC';
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, PlayerInfo.Count) then Exit;
 case FCol of
  0:Value:=PlayerInfo[FRow].SteamID;
  1:Value:=PlayerInfo[FRow].SteamName;
  2:Value:=PlayerInfo[FRow].CharName;
  3:Value:=PlayerInfo[FRow].IP;
  4:Value:=HumanDateTime(PlayerInfo[FRow].LastLoginGlobal);
  5:Value:=IntToStr(PlayerInfo[FRow].TotalPlayTime div 3600)+' ч.';
  6:Value:=PlayerInfo[FRow].From;
  7:Value:=PlayerInfo[FRow].RegDateString;
  8:Value:=FormatFloat('### ### ##0.00', PlayerInfo[FRow].Balance);
  9:Value:=FormatFloat('### ### ##0', PlayerInfo[FRow].Score);
 end;
end;
...
begin
 with (Sender as TTableEx).Canvas do
  begin
   if ACol <> 0 then Exit;
   if PlayersRev.Count > 0 then PRev:=PlayersRev[ARow] else Exit;

   case PRev.Connected of
    True: ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top + 4, 14);  //14
    False: ImageList16.Draw((Sender as TTableEx).Canvas, Rect.Left+4, Rect.Top + 4, 12);  //12
   end;
  end;
end;
...
begin
 ...
 if not IndexInList(FRow, PlayersRev.Count) then Exit;
 case FCol of
  1:if PlayersRev[FRow].Connected then Value:='Подключился'
    else Value:='Отключился';
  2:Value:=PlayersRev[FRow].Player.GameName;
  3:Value:=HumanDateTime(PlayersRev[FRow].DateTime);
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, FLogCommands.Count) then Exit;
 case FCol of
  0:Value:=HumanDateTime(FLogCommands[FRow].Date);
  1:Value:=FLogCommands[FRow].Value;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, FLogGamePlay.Count) then Exit;
 case FCol of
  0:Value:=HumanDateTime(FLogGamePlay[FRow].Date);
  1:Value:=FLogGamePlay[FRow].Value;
 end;
end;
...
begin
 ...
 if not IndexInList(FRow, FLogRCON.Count) then Exit;
 case FCol of
  0:Value:=HumanDateTime(FLogRCON[FRow].Date);
  1:Value:=FLogRCON[FRow].Value;
 end;
end;
...
begin
 Allow:=False;
 if not IndexInList(ARow, FLogSystem.Count) then Exit;
...
begin
 ...
 if not IndexInList(FRow, FLogSystem.Count) then Exit;
 case FCol of
  0:Value:=HumanDateTime(FLogSystem[FRow].Date);
  1:Value:=FLogSystem[FRow].Value;
 end;
end;
 ...
 try
  ...
  while (not Application.Terminated) and (not Thread.Terminated) and (not Thread.Stopping) do
   begin
    ...
    //С сайта в игру
    if not FSiteDB.Connected then Continue;
    CheckSiteChat;
    Thread.Synchronize(
     procedure
     begin
  ...
  on E:Exception do
   begin
    Thread.Work:=twExcept;
    Thread.Synchronize(procedure begin Log(FLogSystem, 'ThreadChatSendToGame '+E.Message) end);
   end;
 end;
end;
...
begin
 ...
 try
  ...
  on E:Exception do
   begin
    Thread.Synchronize(procedure begin Log(FLogSystem, 'ThreadServerGet '+E.Message) end);
    Thread.Work:=twExcept;
   end;
 end;
end;
  ...
  begin
   ...
   if DrawGrid then
    begin
     ...
     if FGridVertPos > GridStep then FGridVertPos:=Step;
   ...
   if StatOnline.Count > 0 then
    begin
     ...
     for j:= StatOnline.Count-1 downto vMin do Points.Add(StatOnline[j]);
   ...
   if StatPing.Count > 0 then
    begin
     ...
     for j:= StatPing.Count-1 downto vMin do Points.Add(StatPing[j]);
     if Points.Count > 0 then
      begin
       Pen.Color:=$0066CCCC;
...
begin
 try
  ...
  while (not Application.Terminated) and (not Thread.Terminated) and (not Thread.Stopping) do
   begin
    ...
    Thread.Synchronize(
     procedure
     begin
      if PCount <> PlayerInfo.Count then RefreshPlayerInfo;
     end);
   end;
  Thread.Work:=twExit;
 except
  on E:Exception do
   begin
    Thread.Synchronize(procedure begin Log(FLogSystem, 'ThreadUpdateProc '+E.Message) end);
    Thread.Work:=twExcept;
   end;
 end;
end;
...
begin
 try
  ...
  on E:Exception do
   begin
    Thread.Synchronize(procedure begin Log(FLogSystem, 'ThreadUpdateProcessData '+E.Message) end);
    Thread.Work:=twExcept;
   end;
 end;
end;
...
begin
 ...
 if Thread.Wait or Thread.Stopped then Result:=$001CA8FF;
 if Thread.Stopping then Result:=$00FFF240;
end;
...
begin
 ...
 if FRestartTimeLeft = (TimeToRestart  -  1) then Say else
 if FRestartTimeLeft = (TimeToRestart div 2) then Say else
 if FRestartTimeLeft = (TimeToRestart div 3) then Say else
 if FRestartTimeLeft <= 10 then Say;
 LabelTimerRestart.Caption:=IntToStr((GetTickCount - TMP));
end;
   ...
   if TelegramIsTimed then
    if TelegramTimer > 0 then
     begin
      ...
      if TelegramTimer <= 0 then StopTelegram;
     end;
  end;
 SetLocalPath;
...
begin
 ...
 case From of
  cfAdmin:
   begin
    ...
    if ChatEng then ChatRec.Text:=TranslateGoogle(ChatRec.Text, 'ru', 'en');
    CColor:=ChatColor;
    SendedMessages.New(Text);
    if ChatRec.PM then Text:='Админ, ЛС: '+Text
    else Text:='Админ: '+Text;
   end;
  cfSite:
   begin
 ...
 else FCommands.Chat(Text, CColor);
end;
...
var SID:TSteamID;
begin
 if not GetCurrentPlayerSteamID(SID) then CheckBoxMiniChatPM.Checked:=False;
end;
...
var DRecord:TDonat;
    i, PID:Integer;
begin
 if not FServerDB.Connect then Exit;
 if not FServerDB.GetDonats(FDonats) then Exit;
 for i:= 0 to FDonats.Count-1 do
  begin
   ...
   if DRecord.Unlimit then Continue;
   if not DRecord.Active then Continue;
...
begin
 if PlayerInfo.Count <= 0 then Exit;
 if not FServerDB.Connected then Exit;
 ...
 for i:= 0 to PlayerInfo.Count-1 do
  begin
   ...
   if FUpdatePlayerInfoFromStop then Break;
   if PlayerInfo[i].From = '' then
    begin
     ...
     if PlayerInfo[i].From <> '' then Updated.Add(Item);
    end;
  end;
  ...
  begin
   if SimpleStrCompare(ChatRecord.Text, FConsoleAnswer[i].Question)*100 > 85 then
    begin
     ...
     else Chat(cfConsole, FConsoleAnswer[i].Answer, ChatRecord.Player.SteamID);
     Exit;
    end;
  end;
end;
...
begin
 if ChatItem.Text = '' then Exit;
 if not MainManager then Exit;
 if ChatItem.Text[1] = '/' then Exit;
...
begin
 ...
 if SetLocalPath then Indicate(LabelExConPath, pbpOK)
 else Indicate(LabelExConPath, pbpError);
end;
...
begin
 ...
 ErrorCode:=0;
 case ErrorEvent of
  eeGeneral: Log(FLogSystem, 'RCON eeGeneral');
  eeSend: Log(FLogSystem, 'RCON Ошибка при отправке');
  eeReceive: Log(FLogSystem, 'RCON Ошибка при приёме');
  eeConnect:
   begin
  ...
  eeAccept: Log(FLogSystem, 'RCON eeAccept');
  eeLookup: Log(FLogSystem, 'RCON eeLookup');
 end;
end;
...
begin
 ...
 for j:= 0 to FChatPlayers.Count-1 do
  if FChatPlayers[j].SteamID = SID then Exit(True);
end;

begin
 if FChatFiltered then Exit;
 LastSID:='';
 FChatPlayers.Clear;
 for i:= 0 to FChatBase.Count-1 do
  begin
   if LastSID = FChatBase[i].Player.SteamID then Continue;
   LastSID:=FChatBase[i].Player.SteamID;
   if FindPlayer(LastSID) then Continue;
   FChatPlayers.Add(FChatBase[i].Player);
  end;
 ComboBoxChatFilter.Items.Clear;
 for i:= 0 to FChatPlayers.Count-1 do ComboBoxChatFilter.Items.Add(FChatPlayers[i].GameName);
end;
...
begin
 if FRunServer(GetServerStartCommandLine) then SpeedButtonConProcClick(nil);
end;
...
begin
 ...
 //Telegram Bot
 FTelegram:=TTelegramBot.Create(nil);
 FTelegram.Token:=BotToken;
 PTelegram:=@FTelegram;
 TelegramTimer:=0;
 TelegramIsTimed:=True;
