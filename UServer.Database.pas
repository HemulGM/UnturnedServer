...
begin
  ...
  begin
    ...
    if Filter <> '' then
      WhereFieldEqual(fieldCHSteamID, Filter);
    Limit := Count;
    Table := FDatabase.GetTable(GetSQL);
    EndCreate;
  end;
...
begin
  ...
  begin
    ...
    try
      ...
      on E: Exception do
        DoExcept(E, 'UpdateBansTable rec: ' + IntToStr(i));
    end;
  end;
  Result := True;
  FSQL.Commit(rDesc);
